...
train_dataset = Badminton_Dataset(
    root_dir=data_dir, split="train", mode=input_type, num_frame=num_frame, slideing_step=1, debug=debug
)
eval_test_dataset = Badminton_Dataset(
...
if __name__ == "__main__":
    ...
    for epoch in range(start_epoch, epochs):
        ...
        loss = train(
            epoch, model, optimizer, WeightedBinaryCrossEntropy, train_loader, input_type, display_step, save_dir
        )
